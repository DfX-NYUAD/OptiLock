...
class SCOPEkBase:
    ...
    def get_FMFS(self, solution):
        ...
        # TODO for later
        return self.scope.get_FMulti_FSingle(solution.get_id())
    ...
    #     return self.muxlink.decode(self.netlist_str, kgss)
    ...
    def lock(self, netlist_str, key_size, alg_type):
        self.scope = SCOPE()
        return self.scope.lock(netlist_str, key_size, alg_type)
